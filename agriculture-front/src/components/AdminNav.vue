  ...
  data(){
    return{
      ...
      adminmenus:[
        ...
        {mid:5,mtitle:'预约管理',mdesp:'预约管理',mpath:'/admin/reserve',mrouter:'Reserve',mvisible:0,state:0,micon: 'el-icon-s-claim'},
        // {mid:6,mtitle:'系统管理',mdesp:'系统管理',mpath:'/admin/system',mrouter:'SystemManage',mvisible:0,state:0,micon: 'el-icon-s-tools',
        //   children:[{mid:7,mtitle:'权限管理',mdesp:'权限管理',mpath:'/admin/auth',mrouter:'AuthManage',mvisible:0,state:0,micon:'el-icon-notebook-2',},
