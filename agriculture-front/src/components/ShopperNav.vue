<template>
  <div class="nav-container">
    <el-menu v-for="item in shoppermenus" :key="item.mid"
             :router="true"
  ...
  data(){
    return{
      ...
      shoppermenus:[
        ...
        {mid:5,mtitle:'预约管理',mdesp:'预约管理',mpath:'/shopper/reserve',mrouter:'Reserve',mvisible:0,state:0,micon: 'el-icon-s-claim'},
      ]
    }
  }
}
